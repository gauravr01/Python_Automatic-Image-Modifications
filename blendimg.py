...
def blend():
    ...
    5. Finally from this joint image Pyramids, reconstruct the
        Original Image.
    '''
    n1 = cv.imread("nature1.jpg")
    n2 = cv.imread("nature2.jpg")

    print(n1.shape)
    print(n2.shape)

    # Resize images to 512x512
    n1 = cv.resize(n1, (512, 512))
    n2 = cv.resize(n2, (512, 512))
    ...
    n2_copy = gp_n2[5]
    lp_n2 = [n2_copy]
    print("gp_n1[i-1] shape:", gp_n1[i-1].shape)
    ("gp_ex shape:", gp_ex.shape)
    lap = cv.subtract(gp_n1[i-1], gp_ex)
